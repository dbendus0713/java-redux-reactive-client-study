...
import myspringboot.r2dbc.customerclient.exception.CustomAPIException;
...
//    @PostConstruct
//    public void init() {
//        webClient = WebClient.builder().baseUrl("http://localhost:8080/router/r2customers")
...
//                .retrieve().bodyToMono(Customer.class);
            .exchangeToMono(response -> {
                if (response.statusCode().equals(HttpStatus.OK)) {
                    ...
                    return Mono.error(() -> new CustomAPIException("Customer Not Found", response.statusCode()));
                } else {
